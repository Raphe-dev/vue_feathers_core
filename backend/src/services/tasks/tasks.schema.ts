...
export const tasksDataSchema = Type.Pick(tasksSchema, ['content', 'order', 'column_id'], {
  $id: 'TasksData',
});
...
export const tasksQueryProperties = Type.Pick(tasksSchema, ['_id', 'column_id', 'content', 'order', 'done']);
